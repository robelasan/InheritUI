...
public class WorksTab extends BaseFrame {
	...
	public WorksTab() {
		...
		//this panel holds all of the images
		...
		//1st image
		javafx.setIcon(new ImageIcon(WorksTab.class.getResource("/images/javafxFinal.png")));
		...
		photoManipulation.setIcon(new ImageIcon(WorksTab.class.getResource("/images/PHOTO MANIPULATION - LASAN.jpg")));
		...
		//3rd image
		chickenLogo.setIcon(new ImageIcon(WorksTab.class.getResource("/images/chickenLogo (1).jpg")));
		...
		//4th image
		girlGamerLogo.setIcon(new ImageIcon(WorksTab.class.getResource("/images/girlgamerLogo (1).jpg")));
		...
		//5th image
		drawingRAM.setIcon(new ImageIcon(WorksTab.class.getResource("/images/drawingRAM (1).jpg")));
		...
		//6th image
		drawingHDD.setIcon(new ImageIcon(WorksTab.class.getResource("/images/digitalHDD (1).jpg")));
		...
		//7th image
		businessCardLogo.setIcon(new ImageIcon(WorksTab.class.getResource("/images/business card (1).png")));
		...
		//8th image
		digitalArt.setIcon(new ImageIcon(WorksTab.class.getResource("/images/digitalArt1 (1).jpg")));
		...
		//9th image
		digitalSelfPortrait.setIcon(new ImageIcon(WorksTab.class.getResource("/images/digitalSelfPortrait (1).jpg")));
		...
		//10th image
		digitalAstro.setIcon(new ImageIcon(WorksTab.class.getResource("/images/digitalAstro (1).jpg")));
		...
		//11th image
		portraitMom.setIcon(new ImageIcon(WorksTab.class.getResource("/images/portraitMom (1).jpg")));
		...
		//12th image
		portraitChaeyoung.setIcon(new ImageIcon(WorksTab.class.getResource("/images/portraitChaeyoung (1).jpg")));
		...
		//13th image
		portraitFriend.setIcon(new ImageIcon(WorksTab.class.getResource("/images/portraitFriend (1).jpg")));
		...
		displayText.setVisible(true);
				...
				blueWatercolor.setIcon(new ImageIcon(WorksTab.class.getResource("/images/blue watercolor.png")));
